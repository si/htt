<div id="sponsors">
  ...
  <ul>
    ...
    <li><a href="http://www.sixnationskickoff.com/">Six Nations KickOff</a></li>
    <li><a href="http://www.worldcupkickoff.com/">World Cup KickOff</a></li>
    <li><a href="http://www.eurokickoff.com/">Euro KickOff</a></li>
  </ul>
<?php
function tla_ads() {
	...
	$LOCAL_XML_FILENAME = "local_266477.xml";
	...
	if( filemtime($LOCAL_XML_FILENAME) < (time() - 3600) || filesize($LOCAL_XML_FILENAME) < 20) {
		...
		tla_updateLocalXML("http://www.text-link-ads.com/xml.php?inventory_key=EDKWJ2RGVHJL58TRG3JT&referer=" . urlencode($request_uri) .  "&user_agent=" . urlencode($user_agent), $LOCAL_XML_FILENAME, $CONNECTION_TIMEOUT);
	}
